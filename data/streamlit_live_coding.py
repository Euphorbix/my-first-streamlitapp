...
#We create a new environment and a
...
mpg_df_raw = load_data(path="raw/mpg.csv")
...
# Widgets: radio buttons --> First you create the variables
...
means = reduced_df.groupby('class').mean() # You integrate what you did before
